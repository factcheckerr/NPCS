...
public class Wikidata extends AbstractQueryModelVisitor<RuntimeException> {
	...
	public Wikidata(EvaluationStrategy strategy,ValueFactory vf,TupleExpr tupleExpr) {
	...
	//	}
		...
		*/
		...
		if(node instanceof Join)
		{
			...
			//wikidata
			else if((leftArg instanceof StatementPattern)&&(rightArg instanceof StatementPattern)&&(((StatementPattern) rightArg).getSubjectVar().getName().equals("fprov"+(totalstPatterns.size()-1))))
			{
					
				System.out.println("topester union");
				System.out.println("fprov"+(totalstPatterns.size()-1));
