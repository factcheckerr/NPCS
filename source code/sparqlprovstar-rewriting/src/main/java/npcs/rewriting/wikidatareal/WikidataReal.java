...
public class WikidataReal extends AbstractQueryModelVisitor<RuntimeException> {
	...
	public WikidataReal(EvaluationStrategy strategy,ValueFactory vf,TupleExpr tupleExpr) {
